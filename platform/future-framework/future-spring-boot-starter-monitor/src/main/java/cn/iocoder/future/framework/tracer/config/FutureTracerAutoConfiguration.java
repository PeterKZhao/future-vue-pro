...
import cn.iocoder.future.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "future.tracer", value = "enable", matchIfMissing = true)
public class FutureTracerAutoConfiguration {
