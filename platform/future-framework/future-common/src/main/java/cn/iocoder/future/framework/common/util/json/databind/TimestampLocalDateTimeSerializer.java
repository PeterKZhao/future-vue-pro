package cn.iocoder.future.framework.common.util.json.databind;
...
public class TimestampLocalDateTimeSerializer extends JsonSerializer<LocalDateTime> {
    ...
    public void serialize(LocalDateTime value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
        // 情况一：有 JsonFormat 自定义注解，则使用它。https://github.com/YunaiV/future-vue-pro/pull/1019
        ...
        if (fieldName != null) {
            ...
            if (currentValue != null) {
                ...
                // 进一步修复：https://gitee.com/zhijiantianya/future-vue-pro/pulls/1480
