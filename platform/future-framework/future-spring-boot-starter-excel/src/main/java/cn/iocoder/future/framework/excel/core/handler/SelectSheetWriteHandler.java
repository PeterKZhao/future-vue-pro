package cn.iocoder.future.framework.excel.core.handler;
...
import cn.iocoder.future.framework.excel.core.function.ExcelColumnSelectFunction;
...
public class SelectSheetWriteHandler implements SheetWriteHandler {
    ...
    public SelectSheetWriteHandler(Class<?> head) {
        ...
        for (Field field : head.getDeclaredFields()) {
            // 关联 https://github.com/YunaiV/future-vue-pro/pull/853
