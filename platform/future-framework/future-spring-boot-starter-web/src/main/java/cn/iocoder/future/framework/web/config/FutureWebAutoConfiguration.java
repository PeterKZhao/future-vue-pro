package cn.iocoder.future.framework.web.config;
...
import cn.iocoder.future.framework.web.core.filter.CacheRequestBodyFilter;
import cn.iocoder.future.framework.web.core.filter.DemoFilter;
import cn.iocoder.future.framework.web.core.handler.GlobalExceptionHandler;
import cn.iocoder.future.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class FutureWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "future.demo", havingValue = "true")
