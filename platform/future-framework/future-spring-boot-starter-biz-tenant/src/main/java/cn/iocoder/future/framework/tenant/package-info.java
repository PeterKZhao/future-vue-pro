 ...
 *      1）Spring Async：
 *          {@link cn.iocoder.future.framework.quartz.config.FutureAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 FutureSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.iocoder.future.framework.tenant;
