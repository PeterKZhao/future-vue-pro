package cn.iocoder.future.module.trade.convert.order;
...
import cn.iocoder.future.framework.common.util.string.StrUtils;
import cn.iocoder.future.framework.dict.core.DictFrameworkUtils;
import cn.iocoder.future.framework.ip.core.utils.AreaUtils;
import cn.iocoder.future.module.member.api.address.dto.MemberAddressRespDTO;
import cn.iocoder.future.module.member.api.user.dto.MemberUserRespDTO;
import cn.iocoder.future.module.pay.api.order.dto.PayOrderCreateReqDTO;
import cn.iocoder.future.module.pay.enums.DictTypeConstants;
import cn.iocoder.future.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import cn.iocoder.future.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.iocoder.future.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.iocoder.future.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.iocoder.future.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.iocoder.future.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.iocoder.future.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.iocoder.future.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.iocoder.future.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.iocoder.future.module.trade.controller.admin.order.vo.*;
import cn.iocoder.future.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.iocoder.future.module.trade.controller.app.order.vo.*;
import cn.iocoder.future.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.iocoder.future.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.iocoder.future.module.trade.dal.dataobject.order.TradeOrderLogDO;
import cn.iocoder.future.module.trade.enums.order.TradeOrderItemAfterSaleStatusEnum;
import cn.iocoder.future.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.iocoder.future.module.trade.framework.order.config.TradeOrderProperties;
import cn.iocoder.future.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.iocoder.future.framework.common.util.collection.CollectionUtils.convertMap;
import static cn.iocoder.future.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static cn.iocoder.future.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/futurecode/future-mall-uniapp/issues/ICY7SJ
