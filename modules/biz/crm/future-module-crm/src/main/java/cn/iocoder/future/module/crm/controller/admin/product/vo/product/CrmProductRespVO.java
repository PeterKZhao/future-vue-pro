package cn.iocoder.future.module.crm.controller.admin.product.vo.product;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "cn.iocoder.future.module.system.dal.dataobject.user.AdminUserDO",
