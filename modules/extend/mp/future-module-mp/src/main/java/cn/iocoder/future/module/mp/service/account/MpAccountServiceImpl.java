package cn.iocoder.future.module.mp.service.account;
...
import cn.iocoder.future.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import cn.iocoder.future.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.iocoder.future.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.iocoder.future.module.mp.convert.account.MpAccountConvert;
import cn.iocoder.future.module.mp.dal.dataobject.account.MpAccountDO;
import cn.iocoder.future.module.mp.dal.mysql.account.MpAccountMapper;
import cn.iocoder.future.module.mp.enums.ErrorCodeConstants;
...
import static cn.iocoder.future.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 future-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
