package cn.iocoder.future.module.iot.core.messagebus.config;

import cn.iocoder.future.framework.mq.redis.core.RedisMQTemplate;
import cn.iocoder.future.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import cn.iocoder.future.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import cn.iocoder.future.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import cn.iocoder.future.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import cn.iocoder.future.module.iot.core.messagebus.core.IotMessageBus;
import cn.iocoder.future.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import cn.iocoder.future.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import cn.iocoder.future.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "future.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "future.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 FutureRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see cn.iocoder.future.framework.mq.redis.config.FutureRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "future.iot.message-bus", name = "type", havingValue = "redis")
