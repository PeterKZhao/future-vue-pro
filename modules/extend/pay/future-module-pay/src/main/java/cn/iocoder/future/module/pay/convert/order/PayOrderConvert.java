package cn.iocoder.future.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, cn.iocoder.future.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
