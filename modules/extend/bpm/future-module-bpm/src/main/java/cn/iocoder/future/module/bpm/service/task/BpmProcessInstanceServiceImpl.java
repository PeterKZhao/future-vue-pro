package cn.iocoder.future.module.bpm.service.task;
...
import cn.iocoder.future.framework.common.util.collection.CollectionUtils;
import cn.iocoder.future.framework.common.util.date.DateUtils;
import cn.iocoder.future.framework.common.util.json.JsonUtils;
import cn.iocoder.future.framework.common.util.object.ObjectUtils;
import cn.iocoder.future.framework.common.util.object.PageUtils;
import cn.iocoder.future.framework.datapermission.core.annotation.DataPermission;
import cn.iocoder.future.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import cn.iocoder.future.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.iocoder.future.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.iocoder.future.module.bpm.controller.admin.task.vo.instance.*;
import cn.iocoder.future.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.iocoder.future.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.iocoder.future.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.iocoder.future.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.iocoder.future.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.iocoder.future.module.bpm.enums.ErrorCodeConstants;
import cn.iocoder.future.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.iocoder.future.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.iocoder.future.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.iocoder.future.module.bpm.enums.task.BpmReasonEnum;
import cn.iocoder.future.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.iocoder.future.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.iocoder.future.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.iocoder.future.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.iocoder.future.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.iocoder.future.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.iocoder.future.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.iocoder.future.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.iocoder.future.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.iocoder.future.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.iocoder.future.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.iocoder.future.module.bpm.service.message.BpmMessageService;
import cn.iocoder.future.module.system.api.dept.DeptApi;
import cn.iocoder.future.module.system.api.dept.dto.DeptRespDTO;
import cn.iocoder.future.module.system.api.user.AdminUserApi;
import cn.iocoder.future.module.system.api.user.dto.AdminUserRespDTO;
...
import static cn.iocoder.future.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.iocoder.future.module.bpm.enums.ErrorCodeConstants.*;
import static cn.iocoder.future.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.iocoder.future.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/future-cloud/issues/ID1UYA
