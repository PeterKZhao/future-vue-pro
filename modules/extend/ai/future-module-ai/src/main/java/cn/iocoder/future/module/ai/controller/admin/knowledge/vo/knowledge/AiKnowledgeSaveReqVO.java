package cn.iocoder.future.module.ai.controller.admin.knowledge.vo.knowledge;
...
public class AiKnowledgeSaveReqVO {
    ...
    @Schema(description = "知识库名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "future-vue-pro 用户指南")
    @NotBlank(message = "知识库名称不能为空")
    private String name;

    @Schema(description = "知识库描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "存储 future-vue-pro 操作文档")
