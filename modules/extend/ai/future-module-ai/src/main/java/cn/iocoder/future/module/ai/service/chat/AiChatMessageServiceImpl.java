package cn.iocoder.future.module.ai.service.chat;
...
import cn.iocoder.future.framework.tenant.core.util.TenantUtils;
import cn.iocoder.future.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.iocoder.future.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.iocoder.future.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.iocoder.future.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.iocoder.future.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.iocoder.future.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.iocoder.future.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.iocoder.future.module.ai.dal.dataobject.model.AiChatRoleDO;
import cn.iocoder.future.module.ai.dal.dataobject.model.AiModelDO;
import cn.iocoder.future.module.ai.dal.dataobject.model.AiToolDO;
import cn.iocoder.future.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.iocoder.future.module.ai.enums.ErrorCodeConstants;
import cn.iocoder.future.module.ai.enums.model.AiPlatformEnum;
import cn.iocoder.future.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import cn.iocoder.future.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import cn.iocoder.future.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import cn.iocoder.future.module.ai.service.knowledge.AiKnowledgeDocumentService;
import cn.iocoder.future.module.ai.service.knowledge.AiKnowledgeSegmentService;
import cn.iocoder.future.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import cn.iocoder.future.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import cn.iocoder.future.module.ai.service.model.AiChatRoleService;
import cn.iocoder.future.module.ai.service.model.AiModelService;
import cn.iocoder.future.module.ai.service.model.AiToolService;
import cn.iocoder.future.module.ai.util.AiUtils;
import cn.iocoder.future.module.ai.util.FileTypeUtils;
...
import static cn.iocoder.future.framework.common.pojo.CommonResult.error;
...
import static cn.iocoder.future.framework.common.util.collection.CollectionUtils.convertSet;
import static cn.iocoder.future.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.iocoder.future.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 future.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 future.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
