package cn.iocoder.future.module.ai.framework.ai.core.model;
...
import cn.iocoder.future.framework.common.util.spring.SpringUtils;
import cn.iocoder.future.module.ai.enums.model.AiPlatformEnum;
import cn.iocoder.future.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.iocoder.future.module.ai.framework.ai.config.FutureAiProperties;
...
import cn.iocoder.future.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.iocoder.future.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            FutureAiProperties.Midjourney properties = SpringUtil.getBean(FutureAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(FutureAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        FutureAiProperties.DouBao properties = new FutureAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(FutureAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        FutureAiProperties.HunYuan properties = new FutureAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(FutureAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        FutureAiProperties.SiliconFlow properties = new FutureAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(FutureAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        FutureAiProperties.XingHuo properties = new FutureAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(FutureAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        FutureAiProperties.BaiChuan properties = new FutureAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(FutureAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        FutureAiProperties.Gemini properties = SpringUtil.getBean(FutureAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        FutureAiProperties.Grok properties = new FutureAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
