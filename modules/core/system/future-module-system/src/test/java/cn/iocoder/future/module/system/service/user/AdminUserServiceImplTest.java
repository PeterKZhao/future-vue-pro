package cn.iocoder.future.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.iocoder.future.framework.common.enums.CommonStatusEnum;
import cn.iocoder.future.framework.common.exception.ServiceException;
import cn.iocoder.future.framework.common.pojo.PageResult;
import cn.iocoder.future.framework.common.util.collection.ArrayUtils;
import cn.iocoder.future.framework.common.util.collection.CollectionUtils;
import cn.iocoder.future.framework.test.core.ut.BaseDbUnitTest;
import cn.iocoder.future.module.infra.api.config.ConfigApi;
import cn.iocoder.future.module.infra.api.file.FileApi;
import cn.iocoder.future.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.iocoder.future.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.iocoder.future.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.iocoder.future.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.iocoder.future.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.iocoder.future.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.iocoder.future.module.system.dal.dataobject.dept.DeptDO;
import cn.iocoder.future.module.system.dal.dataobject.dept.PostDO;
import cn.iocoder.future.module.system.dal.dataobject.dept.UserPostDO;
import cn.iocoder.future.module.system.dal.dataobject.tenant.TenantDO;
import cn.iocoder.future.module.system.dal.dataobject.user.AdminUserDO;
import cn.iocoder.future.module.system.dal.mysql.dept.UserPostMapper;
import cn.iocoder.future.module.system.dal.mysql.user.AdminUserMapper;
import cn.iocoder.future.module.system.enums.common.SexEnum;
import cn.iocoder.future.module.system.service.dept.DeptService;
import cn.iocoder.future.module.system.service.dept.PostService;
import cn.iocoder.future.module.system.service.oauth2.OAuth2TokenService;
import cn.iocoder.future.module.system.service.permission.PermissionService;
import cn.iocoder.future.module.system.service.tenant.TenantService;
...
import static cn.iocoder.future.framework.common.util.collection.SetUtils.asSet;
import static cn.iocoder.future.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.iocoder.future.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.iocoder.future.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.iocoder.future.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.iocoder.future.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.iocoder.future.framework.test.core.util.RandomUtils.*;
import static cn.iocoder.future.module.system.enums.ErrorCodeConstants.*;
import static cn.iocoder.future.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("futureyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("futureyuanma");
        ...
        assertEquals("futureyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("futureyuanma"))).thenReturn("java");
