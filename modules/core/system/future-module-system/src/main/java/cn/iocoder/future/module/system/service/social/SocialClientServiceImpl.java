package cn.iocoder.future.module.system.service.social;
...
import cn.iocoder.future.framework.common.util.cache.CacheUtils;
import cn.iocoder.future.framework.common.util.http.HttpUtils;
import cn.iocoder.future.framework.common.util.object.BeanUtils;
import cn.iocoder.future.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.iocoder.future.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import cn.iocoder.future.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.iocoder.future.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.iocoder.future.module.system.dal.dataobject.social.SocialClientDO;
import cn.iocoder.future.module.system.dal.mysql.social.SocialClientMapper;
import cn.iocoder.future.module.system.dal.redis.RedisKeyConstants;
import cn.iocoder.future.module.system.enums.social.SocialTypeEnum;
import cn.iocoder.future.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.iocoder.future.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.iocoder.future.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${future.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${future.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/future-cloud/pulls/230
