package cn.iocoder.future.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 cn.iocoder.future.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
