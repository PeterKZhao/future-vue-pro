package cn.iocoder.future.module.infra.controller.admin.db.vo;
...
public class DataSourceConfigSaveReqVO {
    ...
    @Schema(description = "数据源连接", requiredMode = Schema.RequiredMode.REQUIRED, example = "jdbc:mysql://127.0.0.1:3306/future-vue-pro")
