package cn.iocoder.future.module.infra.service.logger;
...
import cn.iocoder.future.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.iocoder.future.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.iocoder.future.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.iocoder.future.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.iocoder.future.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.iocoder.future.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("future-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("future-test");
